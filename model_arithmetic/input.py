...
class TokenizedInput:
    ...
    def set_inputs(self, inputs):
        ...
        # self.only_input_tokens = self.tokenizer(only_prompt, return_tensors="pt", truncation=True, max_length=self.max_length, add_special_tokens=False)
    ...
    def add_continuation_tokens(self, tokens):
        ...
        # padded_output = self.tokenizer.pad({"input_ids": truncated_output}, return_tensors="pt")
